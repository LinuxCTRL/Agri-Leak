...
export const getExportAvailableQnz = () => api.get('/api/export-available-qnz')
export const getExportTonnage = (params) => api.get('/api/export-tonnage', { params })
export const askAI = (question) => api.post('/api/ai/chat', { question })
export const getAISummary = (params) => api.get('/api/ai/summarize', { params })